...
class Model_modify(nn.Module):
    ...
    def forward(
        ...
        hidden_states = inputs_embeds.to(hidden_states.dtype)
        hidden_states.requires_grad = self.training
...
if __name__ == "__main__":
    ...
    model = Model_modify(config, load_emb=False)
    print(model)